defmodule Day15Test do
  ...
  for {str, collisons, box_list, expected} <- [
        ...
        {"2 collision", [{2, 1}, {3, 1}, {4, 1}], [{2, 1}, {3, 1}, {4, 1}, {3, 5}],
         {{2, 1}, [{3, 1}, {4, 1}, {3, 5}]}}
      ] do
  ...
  for {str, start_coord, box_list, wall_list, expected} <- [
        ...
        {"2 collision", {1, 1}, [{2, 1}, {3, 1}, {4, 1}, {3, 5}], [],
         {{2, 1}, [{3, 1}, {4, 1}, {3, 5}, {5, 1}]}},
        {"wall collision", {1, 1}, [{2, 1}, {3, 1}, {4, 1}, {3, 5}], [{4, 1}],
         {{1, 1}, [{2, 1}, {3, 1}, {4, 1}, {3, 5}]}}
      ] do
    test "Check determine_list #{str}" do
      assert Day15.determine_list(
               unquote(start_coord),
               "v",
               unquote(wall_list),
               unquote(box_list)
