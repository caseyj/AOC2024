defmodule Day6Test do
  ...
  test "Checks detect_guard_position returns guard position correctly." do
    assert Day6.detect_guard_position({{".", "#", "."}, {".", "^", "."}, {"#", ".", "#"}}) ==
             {1, 1, :north}
  end
  ...
  test "Check get_next_directions" do
    assert Day6.get_next_directions(
             3,
             0,
             :north,
             {{".", ".", "#"}, {".", ".", "#"}, {"#", "#", "#"}, {".", "#", "#"}}
  ...
  test "Check get_next_directions and find_span gives expected span" do
    ...
    assert Day6.find_span(Day6.get_next_directions(2, 1, :north, matrix), matrix) == [
             {1, 1},
             {0, 1}
           ]

    assert Day6.find_span(Day6.get_next_directions(0, 1, :south, matrix), matrix) == [
             {1, 1},
             {2, 1},
             {3, 1}
           ]
    ...
    assert Day6.find_span(Day6.get_next_directions(0, 2, :west, matrix), matrix) == [
             {0, 1},
             {0, 0}
           ]
  end
