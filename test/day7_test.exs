defmodule Day7Test do
  ...
  test "Check build options correctly generated" do
    ...
    assert Day7.build_options(10, 19, 1, [:sum, :mult, :cat]) == [
             {10, 19, :sum, 1},
             {10, 19, :mult, 1},
             {10, 19, :cat, 1}
           ]
  ...
  test "Check operation runner comes up with correct values" do
    ...
    assert Day7.operation_runner(161_011, {16, 10, 13}, [:sum, :mult]) == false
    ...
    assert Day7.operation_runner(161_011, {16, 10, 13}, [:sum, :mult, :cat]) == false
